...
const About = () => {
    ...
    const items: CircleItemProps[] = [
        ...
        },
        {
            className: 'fourth',
            title: 'IT',
            text: 'Разрабатываем и&nbsp;проектируем многоступенчатые IT-продукты. Технологичные и&nbsp;инновационные разработки, на&nbsp;100% отвечающие требованиям,&nbsp;&mdash; один из&nbsp;наших главных ориентиров при создании индивидуальных IT-решений.'
        },
        {
            className: 'third',
    ...
    return (
        <section className={'container about'}>
            ...
            <ul className="about__list">
                ...
                <li className="about__block">
                    <div id={'block6'} className="about__item">
                        <h2 className="about__title subtitle">IT</h2>
                        <p className="about__text text">Разрабатываем и&nbsp;проектируем многоступенчатые IT-продукты. Технологичные и&nbsp;инновационные разработки, на&nbsp;100% отвечающие требованиям,&nbsp;&mdash; один из&nbsp;наших главных ориентиров при создании индивидуальных IT-решений.</p>
                    </div>
                    <svg id={'decor5'} className="about__decor white-circle-rectangle">
                        <use xlinkHref={'/images/svg/sprite.svg#white-circle-rectangle'}></use>
                    </svg>
                </li>
            </ul>
        </section>
